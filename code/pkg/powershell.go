...
func NewPowerShell(connectType int) (PowerShell, error) {
	if connectType == 0 {
...
func (s *PowerShell) Exec(cmd string) (string, error) {
	...
	// https://learn.microsoft.com/en-us/dotnet/api/system.console.error?redirectedfrom=MSDN&view=net-6.0#System_Console_Error
